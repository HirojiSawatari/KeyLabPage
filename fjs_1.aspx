<%@ Page Language="C#" AutoEventWireup="true" CodeFile="fjs_1.aspx.cs" Inherits="js_1" %>
...
<body>
    ...
    <div>
     ...
     <asp:DataList ID="DataList1" runat="server" RepeatDirection="Horizontal" 
      ...
      <br />
      <span class="STYLE4"> <a href="<%# "fjsxx.aspx?ID="+DataBinder.Eval(Container, "DataItem.ID") %>"><%# DataBinder.Eval(Container, "DataItem.名称").ToString()%></a></span></td>
                                                </ItemTemplate>
                                            </asp:DataList>

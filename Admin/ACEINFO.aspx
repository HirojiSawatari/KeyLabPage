<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ACEINFO.aspx.cs" Inherits="Admin_ACEINFO" %>
        ...
        <td style="width: 235px; text-align: left; height: 18px;">
            ...
            &nbsp;</td></tr>
				<tr class="TdStyle"><td style=" text-align: center; width: 151px; height: 18px;">		
		            标&nbsp;&nbsp; 题：</td>
        <td style="width: 235px; text-align: left; height: 18px;">
                                <asp:TextBox ID="txt1" runat="server" Width="385px"></asp:TextBox>
             
        </td></tr>
				<tr class="TdStyle"><td style=" text-align: center; width: 151px; height: 18px;">		
		            &nbsp;路&nbsp;&nbsp; 径：</td>
        <td style="width: 235px; text-align: left; height: 18px;">
                                <asp:TextBox id="txt2" runat="server" Width="386px"></asp:TextBox>

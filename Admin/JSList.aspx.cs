...
public partial class Admin_JSList : System.Web.UI.Page
{
    ...
    private void BindResult()
    {
        ...
        //组合查询条件 
        DataTable dt = DataControl.GetData("select * from  教授 ");
        if (dt != null)
        {
    ...
    protected void gvData_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            DataControl.Execute("delete from 教授 where ID=" + gvData.DataKeys[num]["ID"].ToString() + "");
            BindResult();
        }
    }

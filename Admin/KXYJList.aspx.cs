...
public partial class Admin_KXYJList : System.Web.UI.Page
{
    ...
    private void BindResult()
    {
        ...
        ////组合查询条件 
        //DataTable dt = DataControl.GetData("select * from 科研项目2010后 ");
        //if (dt != null)
        //{
        //    this.gvData.DataKeyNames = new string[] { "序号" };
    ...
    protected void gvData_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        //{
        //    gvData.EditIndex = ((GridViewRow)((LinkButton)e.CommandSource).NamingContainer).RowIndex;
        //}
        //else if (e.CommandName == "Del")
        //{
        //    //DataControl.Execute("delete from 科研项目2010后 where 序号=" + gvData.DataKeys[num]["ID"].ToString() + "");
        //    //BindResult();
        //}
    }

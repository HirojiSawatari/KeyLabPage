...
public partial class Admin_JJJJList : System.Web.UI.Page
{
    ...
    protected void gvData_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            string strUrl = "JJJJ.aspx?ID=" + gvData.DataKeys[num]["ID"].ToString();
            PageBase.OpenWebForm(strUrl);
        }
        else if (e.CommandName == "Del")
        {
            DataControl.Execute("delete from 开放基金简介 where ID=" + gvData.DataKeys[num]["ID"].ToString() + "");
            BindResult();
        }
    }

...
public partial class Admin_XWTPList : System.Web.UI.Page
{
    ...
    protected void gvData_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        //{
        //    string strUrl = "JS.aspx?ID=" + gvData.DataKeys[num]["ID"].ToString();
        //    PageBase.OpenWebForm(strUrl);
        //}
         if (e.CommandName == "Del")
        {
            DataControl.Execute("delete from 新闻图片维护 where ID=" + gvData.DataKeys[num]["ID"].ToString() + "");
            BindResult();
        }
    }
    ...
    protected void gvData_RowCreated(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            LinkButton LinkButton = (LinkButton)e.Row.FindControl("btn_Delete");

...
public partial class Admin_PYText : System.Web.UI.Page
{
    ...
    private void BindResult()
    {
        ...
        //组合查询条件 
        DataTable dt = DataControl.GetData("select * from  研究生培养 ");
        if (dt != null)
        {
    ...
    protected void gvData_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            string strUrl = "PY2.aspx?ID=" + gvData.DataKeys[num]["ID"].ToString();
            PageBase.OpenWebForm(strUrl);
        }
        else if (e.CommandName == "Del")
        {
            DataControl.Execute("delete from 研究生培养 where ID=" + gvData.DataKeys[num]["ID"].ToString() + "");
            BindResult();
        }
    }

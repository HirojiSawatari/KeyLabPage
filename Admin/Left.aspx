	...
	<body  >
		<form id="Form1"  runat="server">
			<div style="height:650px;width:183px; background-color: #e4e4e4;  " >
		         ...
		         <li><a class="qmparent" href="#">日常信息管理</a> 
		        <ul>
                <li><a href="SCSP.aspx" target="OfficeMain" >视频维护</a></li>
		        <li><a href="SYS.aspx" target="OfficeMain" >实验室介绍</a></li>
		        <li><a href="JSList.aspx" target="OfficeMain" >教授信息管理</a></li> 
                <li><a href="PYText.aspx" target="OfficeMain" >培养信息管理</a></li>  
                 <li><a href="XWTPList.aspx" target="OfficeMain" >新闻图片维护</a></li>
                <li><a href="XKJS.aspx" target="OfficeMain" >学科所属教师管理</a></li> 
		        <li><a href="PYList.aspx" target="OfficeMain" >培养信息下载管理</a></li>
                 <li><a href="ACEINFOList.aspx" target="OfficeMain" >学术会议信息修改</a></li>
                 <li><a href="JJJJList.aspx" target="OfficeMain" >开放基金简介维护</a></li>
                 <li><a href="KXYJList.aspx" target="OfficeMain" >科研项目信息维护</a></li>
                <li><a href="PWDEdit.aspx" target="OfficeMain" >修改管理员用户密码</a></li> 		        
		        </ul></li>

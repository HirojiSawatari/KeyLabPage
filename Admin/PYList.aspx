<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PYList.aspx.cs" Inherits="Admin_PYList" %>
   ...
   <div align="center">
                            ...
                            <tr>
                                <td >
                                    <table  
                                        ...
                                        <tr>
                                           <td height="25" width="30%" align="center" class="tdHeader"> [培养信息下载资源管理]</td>
		...
		<asp:ImageButton ID="btnAdd" runat="server" 
            ImageUrl="~/images/button_add.gif" onclick="btnAdd_Click" />
				...
				<asp:BoundField DataField="主题" HeaderText="主题" >
		</asp:BoundField>
				<asp:BoundField DataField="附带文件" HeaderText="附带文件" Visible="False" >
		</asp:BoundField>
